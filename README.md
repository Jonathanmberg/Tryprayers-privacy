...
Information you add in the app may include things like your name, prayer points, people you add, and notes associated with them.

2.2 Preferences and settings
The app stores preferences you configure (for example, reminder times and notification-related choices) so the app can work the way you expect.

2.3 What we do not do in this version
We do not operate user accounts inside the app.
We do not upload the content above to our servers for app functionality, because this version does not include sign-in or cloud sync.
We do not use third-party analytics SDKs in this version as described in the summary.
3. Where your data is stored
Data described in sections 2.1 and 2.2 is stored locally on your device using the app’s on-device database and secure storage, as implemented in the app.

Deleting the app or clearing app data from your device may erase this information, subject to how your phone’s operating system handles app data.

4. Notifications
If you allow notifications, the app may schedule local reminders on your device (for example, a daily time you choose and optional gentle nudges). You can turn these off in the app’s Settings (and you can disable notifications in your device settings).
